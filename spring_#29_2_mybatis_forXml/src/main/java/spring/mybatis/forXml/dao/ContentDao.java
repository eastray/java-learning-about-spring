package spring.mybatis.forXml.dao;
...
import spring.mybatis.forXml.dto.ContentDto;
...
public class ContentDao implements IDao {
	...
	public ArrayList<ContentDto> listDao() {
		...
		ArrayList<ContentDto> dtos = (ArrayList<ContentDto>) template.query(query,new BeanPropertyRowMapper(ContentDto.class));
		return dtos;
	}
